...
int
enc_RobinRights(unsigned char *p, size_t len, const RobinRights *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
dec_RobinRights(const unsigned char *p, size_t len, RobinRights *data, size_t *size)
{
...
return 0;
fail:
free_RobinRights(data);
return e;
}

void
free_RobinRights(RobinRights *data)
{
...
size_t
len_RobinRights(const RobinRights *data)
{
size_t ret = 0;
{
int oldret = ret;
...
int
copy_RobinRights(const RobinRights *from, RobinRights *to)
{
