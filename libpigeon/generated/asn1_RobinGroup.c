...
int
enc_RobinGroup(unsigned char *p, size_t len, const RobinGroup *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
dec_RobinGroup(const unsigned char *p, size_t len, RobinGroup *data, size_t *size)
{
...
return 0;
fail:
free_RobinGroup(data);
return e;
}

void
free_RobinGroup(RobinGroup *data)
{
...
size_t
len_RobinGroup(const RobinGroup *data)
{
size_t ret = 0;
{
int oldret = ret;
...
int
copy_RobinGroup(const RobinGroup *from, RobinGroup *to)
{
