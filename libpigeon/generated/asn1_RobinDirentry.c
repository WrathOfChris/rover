...
int
enc_RobinDirentry(unsigned char *p, size_t len, const RobinDirentry *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
dec_RobinDirentry(const unsigned char *p, size_t len, RobinDirentry *data, size_t *size)
{
...
return 0;
fail:
free_RobinDirentry(data);
return e;
}

void
free_RobinDirentry(RobinDirentry *data)
{
...
size_t
len_RobinDirentry(const RobinDirentry *data)
{
size_t ret = 0;
{
int oldret = ret;
...
int
copy_RobinDirentry(const RobinDirentry *from, RobinDirentry *to)
{
