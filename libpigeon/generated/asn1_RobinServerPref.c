...
int
enc_RobinServerPref(unsigned char *p, size_t len, const RobinServerPref *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
dec_RobinServerPref(const unsigned char *p, size_t len, RobinServerPref *data, size_t *size)
{
...
return 0;
fail:
free_RobinServerPref(data);
return e;
}

void
free_RobinServerPref(RobinServerPref *data)
{
free_RobinHost(&(data)->host);
}

size_t
len_RobinServerPref(const RobinServerPref *data)
{
size_t ret = 0;
{
int oldret = ret;
...
int
copy_RobinServerPref(const RobinServerPref *from, RobinServerPref *to)
{
