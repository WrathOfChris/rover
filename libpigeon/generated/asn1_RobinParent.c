...
int
enc_RobinParent(unsigned char *p, size_t len, const RobinParent *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
dec_RobinParent(const unsigned char *p, size_t len, RobinParent *data, size_t *size)
{
...
return 0;
fail:
free_RobinParent(data);
return e;
}

void
free_RobinParent(RobinParent *data)
{
...
size_t
len_RobinParent(const RobinParent *data)
{
size_t ret = 0;
{
int oldret = ret;
...
int
copy_RobinParent(const RobinParent *from, RobinParent *to)
{
