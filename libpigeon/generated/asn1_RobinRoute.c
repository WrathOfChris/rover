...
int
enc_RobinRoute(unsigned char *p, size_t len, const RobinRoute *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
dec_RobinRoute(const unsigned char *p, size_t len, RobinRoute *data, size_t *size)
{
...
return 0;
fail:
free_RobinRoute(data);
return e;
}

void
free_RobinRoute(RobinRoute *data)
{
free_RobinHandle(&(data)->hdl);
}

size_t
len_RobinRoute(const RobinRoute *data)
{
size_t ret = 0;
{
int oldret = ret;
...
int
copy_RobinRoute(const RobinRoute *from, RobinRoute *to)
{
